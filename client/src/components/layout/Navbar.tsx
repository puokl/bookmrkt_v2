          ...
          <div className="flex items-center justify-around">
            ...
            <div className="items-center justify-center hidden md:flex">
              <div className="mx-2 icon-container">
                <a
                  href="/addproduct"
                  className="relative m-2 text-gray-700 hover:text-gray-900"
                      ...
                      <div className="mb-2 icon-container" key={index}>
                        {item.href ? (
                          <a
                            ...
                            className="flex p-2 text-gray-700 rounded-md hover:text-gray-900 hover:bg-slate-400"
                          >
                            {<item.icon />}
                          ...
                          <div key={index}>
                            ...
                            <button
                              onClick={logOut}
                              className="flex w-full p-2 text-gray-700 rounded-md hover:text-gray-900 hover:bg-slate-400"
                            >
